...
class Room:	
	...
	def createBaseRooms(self):
		...
		self.walls.append([6,0,False,True,6,1,9])
		self.walls.append([7,0,False,True,7,1,9])
		self.walls.append([8,0,False,False,0,0,0])
		
		self.walls.append([0,8,False,False,0,0,2])
		self.walls.append([1,8,False,True,1,7,9])
		self.walls.append([2,8,False,True,2,7,9])
		self.walls.append([3,8,False,True,3,7,9])
		self.walls.append([4,8,False,True,4,7,9])
		self.walls.append([5,8,False,True,5,7,9])
		self.walls.append([6,8,False,True,6,7,9])
		self.walls.append([7,8,False,True,7,7,9])
		self.walls.append([8,8,False,False,0,0,3])
		...
		self.walls.append([0,6,False,True,1,6,10])
		self.walls.append([0,7,False,True,1,7,10])
		
		self.walls.append([8,1,False,True,7,1,10])
		self.walls.append([8,2,False,True,7,2,10])
		self.walls.append([8,3,False,True,7,3,10])
		self.walls.append([8,4,False,True,7,4,10])
		self.walls.append([8,5,False,True,7,5,10])
		self.walls.append([8,6,False,True,7,6,10])
		self.walls.append([8,7,False,True,7,7,10])
		
		self.walls.append([2,2,False,False,0,0,1])
		self.walls.append([3,2,False,False,0,0,11])
		self.walls.append([2,3,False,False,0,0,14])
		
		self.walls.append([5,2,False,False,0,0,13])
		self.walls.append([6,2,False,False,0,0,0])
		self.walls.append([6,3,False,False,0,0,14])
		
		self.walls.append([2,5,False,False,0,0,12])
		self.walls.append([2,6,False,False,0,0,2])
		self.walls.append([3,6,False,False,0,0,11])
		
		self.walls.append([6,6,False,False,0,0,3])
		self.walls.append([6,6,False,False,0,0,13])
		self.walls.append([6,5,False,False,0,0,12])
